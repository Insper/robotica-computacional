...
class DistanceEstimator(Aruco3d):
    def __init__(self):
        Aruco3d.__init__(self,
                         camera_matrix='/home/borg/colcon_ws/src/robotica-computacional-aps/my_package/my_package/config/cameraMatrix_realsense.txt',
                         camera_distortion='/home/borg/colcon_ws/src/robotica-computacional-aps/my_package/my_package/config/cameraDistortion_realsense.txt'
                         )
